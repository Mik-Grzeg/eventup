...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:9080/api/v1/services')
      .then(response => {
  ...
  const handleCreateService = (newService) => {
    axios.post('http://localhost:9080/api/v1/services', newService)
      .then(response => {
  ...
  const handleUpdateService = (updatedService) => {
    axios.put(`http://localhost:9080/api/v1/services/${updatedService.service_id}`, updatedService)
      .then(response => {
  ...
  const handleRemoveService = (serviceId) => {
    axios.delete(`http://localhost:9080/api/v1/services/${serviceId}`)
      .then(() => {
